...
export function NavUser({
  ...
  const nameShorten = (name: string): string => {
      ...
      <SidebarMenuItem>
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              <Avatar className="h-8 w-8 rounded-lg">
                ...
                <AvatarFallback className="rounded-lg">{nameShorten(user.name)}</AvatarFallback>
              </Avatar>
          ...
          >
            ...
            <DropdownMenuGroup>
              <DropdownMenuItem onClick={()=>redirectRouter("profile")}>
                <BadgeCheck />
                profile
              </DropdownMenuItem>
            </DropdownMenuGroup>
